...
import fondologo from "../../img/rigo-baby.jpg";
...
export const My_Account = () => {
  ...
  return (
    <div className="my-account-css">
      <div className="d-flex m-5 justify-content-center h-80 ">
        ...
        <div
          className={`flex-fill slide-in-right ${
            animation == 1 ? "slide-in-right" : "nada"
          } borde `}
          style={estilo}
        >
